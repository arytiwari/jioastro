...
export default function AdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'knowledge' | 'users' | 'cities' | 'expert-contributions'>('knowledge')
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            ...
            <button
              onClick={() => router.push('/admin/dashboard/expert-contributions')}
              className={`${
                activeTab === 'expert-contributions'
                  ? 'border-jio-600 text-jio-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
              } whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
            >
